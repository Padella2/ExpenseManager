...
class Azione{
	...
	public:
		...
		void getDescrizione(char* descrizione) { 
			strncpy(descrizione, this->descrizione, 256);  
		}
		//! \fn getData
		...
		unsigned int getNumeroPartecipanti(void) { 
			return numero_partecipanti; 
		}
		//! \fn setDescrizione
		...
		void setPagatore(unsigned int pagatore) {
